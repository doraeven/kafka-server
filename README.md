...
![Static Badge](https://img.shields.io/badge/tag-4.2.1-blue)
...
- [Release Notes](https://downloads.apache.org/kafka/4.2.1/RELEASE_NOTES.html)

### Upgrading to 4.2.1
Note: Apache Kafka 4.0 only supports KRaft mode - ZooKeeper mode has been removed. 
Link: [Upgrading Servers to 4.2.1 from any version 3.3.x through 4.1.x](https://kafka.apache.org/42/getting-started/upgrade/)
...
EL10
```shell
rpm -ivh kafka-4.2.1-1.el10.x86_64.rpm
```
EL9
```shell
rpm -ivh kafka-4.2.1-1.el9.x86_64.rpm
```
EL8
```shell
rpm -ivh kafka-4.2.1-1.el8.x86_64.rpm
```
...
Debian or Ubuntu
```shell
dpkg -i kafka_4.2.1-1_amd64.deb
```
...
EL10
```shell
rpm -e kafka-4.2.1-1.el10.x86_64
```
EL9
```shell
rpm -e kafka-4.2.1-1.el9.x86_64
```
EL8
```shell
rpm -e kafka-4.2.1-1.el8.x86_64
```
