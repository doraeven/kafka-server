...
# /etc/kafka/kraft/reconfig-server.properties
# replace kraft/reconfig-server.properties with datadir log.dirs=/tmp/kraft-combined-logs -> log.dirs=/var/lib/kraft/kraft-combined-logs
sed -i "s:^log.dirs=.*:log.dirs=/var/lib/kraft/kraft-combined-logs:" ${PACKAGE_NAME}-new/config/kraft/reconfig-server.properties
